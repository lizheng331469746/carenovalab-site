...
export default function HowWeWorkPage(){return <>
  <PageHero eyebrow="How We Work" title="A Clear Product Process From First Brief to Launch Preparation" description="We organize each project as a sequence of decisions. This reduces disconnected sampling, packaging changes, unclear quotations and avoidable production delays." image="/images/site/home-hero-lab-serum.webp" backgroundImage="https://sc02.alicdn.com/kf/H5020e711c9914557976ceabc3d0611cax.jpg" primaryLabel="Start Your Project" primaryContext={{source:'How We Work page'}} secondaryLabel="Complete a Project Brief" secondaryHref="/start-your-project"/>
