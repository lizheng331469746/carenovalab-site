...
export interface ProductFact { label: string; value: string; group?: string }
...
export interface Manufacturing {
  ...
  productCertifications?: { name: string; scope: string; evidenceReference: string }[];
...
export interface Product {
  ...
  customizationIntro?: { heading: string; description: string };
